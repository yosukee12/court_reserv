...
class NavigationService:
    ...
    def select_lottery_tennis_park(
        ...
        if not self._lottery_hidden_selection_matches(
            ...
            raise TimeoutException(message)
        self.logger.info(
            "after_iname_select: %s",
            json.dumps(
                {
                    "selected_by": selected_by,
                    "resolved_value": resolved_court_value,
                    "bname_value": hidden_state.get("bname_value"),
                    "bname_text": hidden_state.get("bname_text"),
                    "iname_value": hidden_state.get("iname_value"),
                    "iname_text": hidden_state.get("iname_text"),
                    "selectBldGrpCd": hidden_state.get("selectBldGrpCd"),
                    "selectInstGrpCd": hidden_state.get("selectInstGrpCd"),
